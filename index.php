   ...
   <!--visit https://www.w3schools.com/bootstrap/bootstrap_forms.asp search for forms template and use it.-->
    ...
    <form action="" name="form1" method="post">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="manufacture" placeholder="Enter manufacture" name="manufacture">
        </div>
        <div class="form-group">
...
<div class="col-lg-12">
    <table class="table table-bordered">
        ...
        while($row=mysqli_fetch_array($res))
        {
            ...
            echo "<td>"; echo $row["manufacture"]; echo "</td>";
...
{
    mysqli_query($link,"insert into laptops values (NULL,'$_POST[manufacture]','$_POST[ram]','$_POST[cpu]','$_POST[contact]')");
   ?>
...
{
    mysqli_query($link,"delete from laptops where manufacture='$_POST[manufacture]'");
    ?>
    <script type="text/javascript">
        window.location.href=window.location.href;
    </script>
...
{
    mysqli_query($link,"update laptops set ram='$_POST[ram]' where manufacture='$_POST[manufacture]'");
    ?>
    <script type="text/javascript">
        window.location.href=window.location.href;
    </script>
